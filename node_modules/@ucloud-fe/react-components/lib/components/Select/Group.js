...
var Group = (_temp = _class = function (_Component) {
    ...
    _createClass(Group, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = _objectWithoutProperties(_props, ['groupKey']);

            return _react2.default.createElement(_Menu2.default.SubMenu, _extends({}, rest, { subMenuKey: groupKey }));
        }
    }]);
    ...
    /** @ignore */
    unselectAll: _propTypes2.default.func,
    /** 子菜单的唯一key，也用作collapse的panel的key */
    groupKey: _propTypes2.default.any
}, _temp);
