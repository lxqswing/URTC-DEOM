...
var Drawer = (_temp = _class = function (_React$PureComponent) {
    ...
    closeHandler: _propTypes2.default.node
}, _class.defaultProps = {
    prefixCls: 'drawer',
    placement: 'left',
    getContainer: 'body',
    ...
    this.getChildToRender = function (open) {
        ...
        var _props4 = _this4.props,
            ...
            props = _objectWithoutProperties(_props4, ['wrapperClassName', 'className', 'children', 'style', 'width', 'height', 'defaultOpen', 'firstEnter', 'open', 'prefixCls', 'placement', 'level', 'levelMove', 'ease', 'duration', 'getContainer', 'handler', 'onChange', 'afterVisibleChange', 'onMaskClick', 'onHandleClick', 'showMask', 'maskStyle', 'keyboard', 'closeHandler']);
        /* eslint-enable no-unused-vars */


        var wrapperClassName = (0, _classnames3.default)(prefixCls, (_classnames = {}, _defineProperty(_classnames, prefixCls + '-' + placement, true), _defineProperty(_classnames, prefixCls + '-open', open), _defineProperty(_classnames, className, !!className), _defineProperty(_classnames, 'no-mask', !showMask), _classnames));
